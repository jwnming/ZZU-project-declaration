...
<script language="javascript" type="text/javascript" src="${pageContext.request.contextPath}/user/js/Kunyi.Init.js"></script><header><div class="topHidden"></div>
<div class="toolBase" style="background-color: #C0E0FF;"><div class="BaseMark">
 ...
 <div class="language">选择语言</div><div class="langBtn animated"><i class="flag"></i>中文<i class="downBtn"></i>
   <a href="javasript:;"><img src="${pageContext.request.contextPath}/userimages/ico_003.png" class="animated" width="13" height="13" />中文</a>
 </div></div></div>
<div class="BaseMark logoBase"><a href="${pageContext.request.contextPath}/user/index.jsp"><img src="${pageContext.request.contextPath}/user/images/logo1.png" class="load" width="399" height="70" /></a>
...
<div class="navBase" >
    ...
    <div class="quickMenus" style="background-color: #C0E0FF;">
        <ul class="firstUl">
            <li class="first"><a href="${pageContext.request.contextPath}/user/index.jsp" class="firstA"><em>申报中心首页</em><i class="style02"></i><span></span></a></li>
            <li class="first"><a href="${pageContext.request.contextPath}/user/index_guide.jsp" class="firstA"><em>申报指南</em><i class="style01"></i><span></span></a></li>

            <li class="first"><a href="${pageContext.request.contextPath}/user/main_shenbao.jsp" class="firstA"><em>项目申请</em><i class="style03"></i><span></span></a>

               <%-- <div class="QMSub QMSubMenus">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/user/main_shenbao.jsp" >项目申报系统<span>进入</span></a></li>
                        <li><a href="#" >申报人须知<span>点击下载</span></a></li>
                        <li><a href="#" >申报材料准备说明<span>点击下载</span></a></li>
                        <li><a href="#" >经费采购说明<span>点击下载</span></a></li>
                        <li><a href="#" >项目验收说明<span>点击下载</span></a></li>
                    </ul><div class="clear"></div>
                </div>--%>
            </li>
            <li class="first"><a href="${pageContext.request.contextPath}/login.jsp" class="firstA"><em>进入后台</em><i class="style04"></i><span></span></a>
                <!--xxx-->
            </li>
            <li class="first"><a href="#" class="firstA"><em>材料下载</em><i class="style05"></i><span></span></a>
                <!--xxx-->
                <div class="QMSub QMSubMenus">
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/download/download1.do" >申报人须知<span>点击下载</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/download/download2.do" >申报材料准备说明<span>点击下载</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/download/download3.do" >经费采购说明<span>点击下载</span></a></li>
                        <li><a href="${pageContext.request.contextPath}/download/download4.do" >项目验收说明<span>点击下载</span></a></li>
                    </ul><div class="clear"></div>
                </div>

            </li>
            <li class="first"><a href="#" class="firstA"><em>办公室联系方式</em><i class="style06"></i><span></span></a>
                <div class="QMSub QMSubMenus">
                    <br />
                    <p style="margin-left: 30px; font-size: 16px;">办公室电话：0394-23524368</p>
                    <p style="margin-left: 30px; font-size: 16px;">办公室邮箱：zzushenbao@163.com</p>
                    <p style="margin-left: 30px; font-size: 16px;">负责人手机：15235243628（蒋老师）</p>
                    <p style="margin-left: 30px; font-size: 16px;">负责人手机：12352234428（李老师）</p>
                    <p style="margin-left: 40px; font-size: 13px;color:red;">提醒：请在工作日内联系，非诚勿扰!</p>

                    <div class="clear"></div>
                </div>
            </li>
            <li class="first last"><a href="#" class="firstA"><em>其他</em><i class="style07"></i><span></span></a></li>
        </ul>
    </div>
    </div>
...
<ul><li class="PMenu"><a href="index.jsp" class="PAMenu" >申报中心首页</a></li>
    ...
    <li class="PMenu"><img src="${pageContext.request.contextPath}/admin/upload/banner1.jpg" class="animated" width="15" height="8" /><a id="Nav_AMenu1" class="PAMenu" title="学校简介">学校简介</a>
     <div class="navboxBase">
        ...
        <div class="navSub5">
        <img src="pictures/banner2.jpg" width="299" height="97"/>
        ...
        <div class="navSub6">
        <img src="pictures/banner1.jpg" width="192" height="92" />
        <ul>
...
<section class="bannerBase BaseMark">
    <div class="Banners">
        <ul class="AnimUl">
            <c:forEach items="${sessionScope.rotationExhibition}" var="rotation">
                <li><a href="#" title="${rotation.title}" ><img src="${pageContext.request.contextPath}${rotation.imagePath}" alt="${rotation.title}" /></a></li>

            </c:forEach>

            <%--<li><a href="#" title="展示" ><img src="${pageContext.request.contextPath}/admin/upload/rotations/banner2.jpg" alt="关于郑州大学最新、最优秀的项目团队的展示及说明" /></a></li>
            <li><a href="#" title="展示" ><img src="${pageContext.request.contextPath}/admin/upload/rotations/banner3.jpg" alt="关于郑州大学最新、最优秀的项目团队的展示及说明" /></a></li>
            <li><a href="#" title="展示" ><img src="${pageContext.request.contextPath}/admin/upload/rotations/banner4.jpg" alt="关于郑州大学最新、最优秀的项目团队的展示及说明" /></a></li>
            <li><a href="#" title="展示" ><img src="${pageContext.request.contextPath}/admin/upload/rotations/banner5.jpg" alt="关于郑州大学最新、最优秀的项目团队的展示及说明" /></a></li>
--%>
        </ul>
        <div class="tools">
...
<section class="doctorsBase BaseMark">
    <div class="toolsBase">
        <div class="title"><em>优秀负责人介绍</em><span>Introduction</span></div>
        <div class="tools">
    ...
    <div class="contents">
        <ul data-num="0" id="userExhibition">
            <%--展示推荐--%>
            <c:forEach items="${sessionScope.userExhibition}" var="user_e">
            <li><a href="${pageContext.request.contextPath}/user/getUserByIdExhibition/${user_e.id}" class="img"><img alt="个人头像" src="${pageContext.request.contextPath}${user_e.picture}" width="120" height="162" /></a>
                <a href="${pageContext.request.contextPath}/user/getUserByIdExhibition/${user_e.id}" class="name">${user_e.name}</a>
                <a href="${pageContext.request.contextPath}/user/getUserByIdExhibition/${user_e.id}" class="office">${user_e.department}</a>
                <a href="${pageContext.request.contextPath}/user/getUserByIdExhibition/${user_e.id}" class="post">${user_e.level}${user_e.major}${user_e.clazz}</a>
                <a href="${pageContext.request.contextPath}/user/getUserByIdExhibition/${user_e.id}" class="btn more" style="width:174px;">详细介绍</a>
            </li>
            </c:forEach>

            <%--
            <li>
                <a href="#" class="img"><img alt="姓名" title="姓名" src="pic/201603221527067.png" width="120" height="162" /></a>
                <a href="#" class="name">姓名</a>
                <a href="#" class="office">郑州大学软件与应用科技学院</a>
                <a href="#" class="post">教师  研究生导师</a>
                <a href="#" class="btn more">详细介绍</a>
                <a href="#" class="btn date">项目详情</a>
            </li>
            --%>
...
<section class="officesBase BaseMark">
    <div class="toolsBase">
        <div class="title"><em>优秀项目</em>  <span>Project Introduction</span></div>
        <div class="tools">
            <a href="javascript:;" class="Aprev"></a>
            <a href="javascript:;" class="Anext"></a>
        </div>
    ...
    <div class="contents">
        <ul data-num="0">
            ...
            <c:forEach items="${sessionScope.projectExhibition}" var="project_e">
                <li>
                    <i class="ico01"></i>project
                    <div class="img animated"><img alt="项目logo" src="${pageContext.request.contextPath}/user/pictures/project_logo.png" width="80" height="80" /></div>
                    <a href="#" class="office">${project_e.name}</a>
                    <p>学生团队项目</p>
                    <a href="${pageContext.request.contextPath}/project/getProjectByIdExhibition/${project_e.id}" class="btn more">查看详细</a>
                    <a href="${pageContext.request.contextPath}/user/getUserByIdExhibition/${project_e.user_id}" class="btn doctor">负责人</a>
                </li>
            </c:forEach>
...
<footer style="background-color: #C0E0FF;"><img src="images/ico_036.png" width="35" class="load" height="18" id="QRMark" />
<div class="menusBase" style="background-color: #C0E0FF;">
<div class="websiteInfo">
    <div class="info">主办单位：郑州大学  &nbsp; &nbsp; 服务电话：12352345&nbsp;&nbsp; &nbsp;综合服务中心电话：12356345 &nbsp; 传真：3265734634 &nbsp; 地 址：河南省郑州市中原区科学大道100号 &nbsp;<br/> 版权所有：郑州大学  </div>
  <div class="clear"></div>
  <p> &copy;<script language="javascript" type="text/javascript">document.write(new Date().getFullYear());</script>-<script language="javascript" type="text/javascript">document.write(new Date().getFullYear());</script>. All Rights Reserved. <a href="#">备案号0000001 </a></p>
